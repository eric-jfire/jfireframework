...
public class DirectObjectField extends CacheField
{
    ...
    private static Map<Class<?>, Boolean> resultMap     = new ConcurrentHashMap<Class<?>, Boolean>();
    // 某个类型的维度
    private static Map<Class<?>, Integer> cacheDimMap   = new ConcurrentHashMap<Class<?>, Integer>();
    // 某个类型所使用的基本field来分析
    private static Map<Class<?>, Integer> fieldIndexMap = new ConcurrentHashMap<Class<?>, Integer>();
