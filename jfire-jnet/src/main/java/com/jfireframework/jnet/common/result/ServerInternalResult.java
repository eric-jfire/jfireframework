...
import com.jfireframework.jnet.server.CompletionHandler.BatchWriteCompletionHandler;
...
public class ServerInternalResult extends AbstractInternalResult
{
	...
	private BatchWriteCompletionHandler	writeCompletionHandler;
	private ReadCompletionHandler		readCompletionHandler;
	
	public ServerInternalResult(long version, Object data, ServerChannelInfo channelInfo, ReadCompletionHandler readCompletionHandler, BatchWriteCompletionHandler writeCompletionHandler, int index)
	{
		init(version, data, channelInfo, readCompletionHandler, writeCompletionHandler, index);
	}
	
	public void init(long version, Object data, ServerChannelInfo channelInfo, ReadCompletionHandler readCompletionHandler, BatchWriteCompletionHandler writeCompletionHandler, int index)
	{
	...
	public void write(long version)
	{
		...
		channelInfo.socketChannel().write(new ByteBuffer[] { ((ByteBuf<?>) data).nioBuffer() }, 0, 1, 10, TimeUnit.SECONDS, new ByteBuf[] { (ByteBuf) data }, writeCompletionHandler);
	}
